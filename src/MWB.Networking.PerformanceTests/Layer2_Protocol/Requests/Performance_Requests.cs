...
/// </summary>
[TestClass]
public sealed partial class Performance_Requests
{
    ...
    public void Layer2_Protocol_Performance_Requests_10000()
    {
        ...
        for (var i = 0; i < Performance.WarmupIterations; i++)
        {
        ...
        for (var i = 0; i < Performance.Iterations; i++)
        {
            runtime.ProcessFrame(ProtocolFrames.Request(Id));
            runtime.ProcessFrame(ProtocolFrames.Response(Id));
        }
        ...
        Performance.Report(this.TestContext, "Requests (open + complete)", sw, Performance.Iterations);
    }
    ...
    public void Layer2_Protocol_Performance_Streams_OpenSendClose_10000()
    {
        ...
        Performance.Report(this.TestContext, "Streams (open + 4-byte data + close)", sw, Performance.Iterations);
    }
}
