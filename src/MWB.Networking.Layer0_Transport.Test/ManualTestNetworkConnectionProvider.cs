...
/// </summary>
public sealed class ManualTestConnectionProvider
    : INetworkConnectionProvider, IDisposable
{
    private readonly LogicalConnectionHandle _handle;
    private bool _disposed;

    public ManualTestConnectionProvider(ILogger logger)
    {
    ...
    {
        ObjectDisposedException.ThrowIf(_disposed, nameof(ManualTestConnectionProvider));
    }
}